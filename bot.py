...
async def report(ctx, user, reason, *message):
    if len(ctx.message.mentions) > 0:
        ...
        reply = discord.Embed(name="Thank you! Your report has been send to our staff team for a review.", value="Please note that reports that are NOT TRUE will transfer the punishment to YOU!", color=3adf00)
